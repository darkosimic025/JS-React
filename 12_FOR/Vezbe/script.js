...
// 21.Zadatak________________________________________________________________________
...
//         <li> Element ${item}
//             <ul>
//                 <li style="color: purple;">Element ${item + 1} </li>
//             </ul>
//         </li>
//         `;
//     }
...
// 22.Zadatak_______________________________________________________________________

// sekcija = `<div>`;
// for (kocka = 1; kocka <= 64; kocka++) {
//     if (kocka % 8 == 1) {
//         sekcija += `<span class="osma">${kocka}</span>`;
//     } else {
//         sekcija += `<span>${kocka}</span>`;
//     }

//     sekcija += `</div>`
// } document.body.innerHTML += sekcija;

// 23.Zadatak_________________________________________________________________________
